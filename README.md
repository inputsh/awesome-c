...
* [PCC][74] - Venerable C compiler. Supports C99. [Various licenses][75], all free.
...
* [libgcrypt][142] - General-purpose cryptography library, with a range of available ciphers. [GNU LGPL2.1][15] or later (code), [GNU GPL2.1][8] or later (manual and tools).
...
* [GTK-Doc][319] - Tool for generating C documentation from annotated sources. Has support for the Autotools. [GNU GPL2.1][15] only (code), [GNU FDL1.1][375] only.
...
* [MinGW-w64][287] - Minimalist environment for C development on Windows with 64 bit support. [Various licenses, all free][252].
...
* [EFL][119] - Large collection of useful data structures and functions. Various licenses, all free.
...
* [PBL][346] - Large library of utilities, featuring data structures, among other things. [GNU LGPL2.1][15] or later (library), [GNU GPL2.1][8] or later (test code).
...
* [Cogl][127] - GPU graphics and utilities API. [Expat][11] (dependent on [3-clause BSD][6] and possibly [LGPLv2.1][15] only libs).
...
* [FFMPEG][63] - Complete, cross-platform solution to record, convert and stream audio and video. [GNU LGPL2.1][15] or later, with some parts under [GNU GPL2.1][8] or later.
...
* [GNU MPFR][176] - Library for arbitrary-precision floating-point arithmetic. [GNU LGPL3][5] or later (most recent versions), [GNU LGPL2.1][15] or later (until version 2.4.x).
...
* [gnulib][46] - Collection of common GNU code. Various licenses, all free.
...
* [libgiconv][163] - Text conversion library. [GNU LGPL2.1][15] only (library), [GNU GPL3][41] only (*iconv* program).
...
* [Make][324] - Tool which controls the generation of executables and other non-source files of a program. [GNU GPL3][41] or later (link to the GNU implementation).
...
* [CommonMark][223] - C implementation of the CommonMark spec. [Variety of licenses, all free][224].
...
* [gjrand][327] - Library of random-number generation routines. [GNU GPL2.1][8] or [GNU GPLv3][41] (user's choice).
...
* [libimobiledevice][354] - Cross-platform protocol library to communicate with iThings. [GNU LGPLv2.1][15] or later (library), [GNU GPL2.1][8] or later (tools).
